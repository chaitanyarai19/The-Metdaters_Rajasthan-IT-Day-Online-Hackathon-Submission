...
$sql=mysqli_query($con,"insert into products(category,subCategory,productName,productCompany,productDescription,productPrice,productpricebd,shippingCharge,productquantity,productAvailability,productImage1) 
values('$category','$subcat','$productname','$productcompany','$productdescription','$productprice','$productpricebd','$productscharge','$productquantity','$productavailability','$productimage1')");
