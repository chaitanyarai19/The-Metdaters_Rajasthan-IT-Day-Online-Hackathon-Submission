...
<div class="sidebar-widget wow fadeInUp outer-bottom-xs ">
	...
	<div id="category" class="category-carousel hidden-xs">
		<div class="item">
			...
			<div class="image">
				<img style="height:300px;" src="img/slider/slider 4.png" alt="" class="img-responsive">
			</div>
				...
				<div class="action">
					<ul class="list-unstyled">
						...
						<li class="add-cart-button btn-group">
							...
							<button class="btn btn-primary" type="button" style="background:#f5a700;">Add to cart</button></a>
								<?php } else {?>
